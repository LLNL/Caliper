...
void test_allocation(void* ptr, size_t size) {
    ...
    cali_variant_t v_p_i = cali_make_variant(CALI_TYPE_ADDR, &ptr_inside, sizeof(void*));
    cali_variant_t v_p_o = cali_make_variant(CALI_TYPE_ADDR, &ptr_outside, sizeof(void*));
...
void ci_test_alloc() {
    ...
    cali_id_t ptr_in_attr = cali_create_attribute_with_metadata("ptr_in",
                                                                CALI_TYPE_ADDR,
                                                                CALI_ATTR_ASVALUE,
                                                                1,
                                                                &cali_class_memoryaddress_attr_id,
                                                                &v_true);
    cali_id_t ptr_out_attr = cali_create_attribute_with_metadata("ptr_out",
                                                                 CALI_TYPE_ADDR,
                                                                 CALI_ATTR_ASVALUE,
                                                                 1,
                                                                 &cali_class_memoryaddress_attr_id,
