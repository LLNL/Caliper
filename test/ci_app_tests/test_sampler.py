...
class CaliperSamplerTest(unittest.TestCase):
    ...
    def test_hatchet_sample_profile(self):
        target_cmd = [ './ci_test_macros', '5000', 'hatchet-sample-profile(sample.callpath=false,lookup.module=false,lookup.sourceloc=false,output=stdout,output.format=cali)' ]
