...
int main(int argc, char* argv[]) {
    ...
    cali_id_t iter_attr = cali_create_attribute("iteration", CALI_TYPE_INT, CALI_ATTR_ASVALUE);
    ...
    cali_id_t      meta_attr = cali_create_attribute("meta-attr", CALI_TYPE_INT, CALI_ATTR_DEFAULT);
    cali_variant_t meta_val = cali_make_variant_from_int(47);

    cali_id_t test_attr = cali_create_attribute_with_metadata("test-attr-with-metadata",
                                                              CALI_TYPE_STRING,
                                                              CALI_ATTR_UNALIGNED,
                                                              1,
                                                              &meta_attr,
