...
Node* CaliperMetadataDB::merge_node(
    cali_id_t      node_id,
    cali_id_t      attr_id,
    cali_id_t      prnt_id,
    const Variant& value,
...
EntryList CaliperMetadataDB::merge_snapshot(
    size_t          n_nodes,
    const cali_id_t node_ids[],
    size_t          n_imm,
    const cali_id_t attr_ids[],
...
Attribute CaliperMetadataDB::create_attribute(
    const std::string& name,
    cali_attr_type     type,
    int                prop,
    int                meta,
...
std::vector<Entry> CaliperMetadataDB::import_globals(
