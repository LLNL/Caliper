...
NestedExclusiveRegionProfile::NestedExclusiveRegionProfile(
...
void NestedExclusiveRegionProfile::operator() (CaliperMetadataAccessInterface& db, const std::vector<Entry>& rec)
{
    mP->process_record(db, rec);
}

std::tuple<std::map<std::string, double>, double, double> NestedExclusiveRegionProfile::result() const
{
