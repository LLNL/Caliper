...
void create_caliper_instrumentation_mod(py::module_& caliper_instrumentation_mod) {
    ...
    cali_attribute_type.def(py::init<const char*, cali_attr_type>(),
                            ...
                            py::arg(),
                            py::arg());
    cali_attribute_type.def(py::init<const char*, cali_attr_type, cali_attr_properties>(),
    ...
    caliper_instrumentation_mod.def("begin_phase",
                                    &cali_begin_phase,
    ...
    caliper_instrumentation_mod.def("begin_comm_region",
    ...
    caliper_instrumentation_mod.def("begin_byname",
                                    &cali_begin_byname,
    ...
    caliper_instrumentation_mod.def("begin_byname",
                                    ...
                                    "Same as Annotation.begin, but refers to annotation by name.");
    caliper_instrumentation_mod.def("set_byname",
    ...
    caliper_instrumentation_mod.def("set_byname",
                                    ...
                                    "Same as Annotation.set, but refers to annotation by name.");
    caliper_instrumentation_mod.def("end_byname",
                                    &cali_end_byname,
