...
void create_caliper_config_manager_mod(py::module_& caliper_config_manager_mod) {
    ...
    config_mgr_type.def("set_default_parameter",
    ...
    config_mgr_type.def("set_default_parameter_for_config",
    ...
    config_mgr_type.def("available_config_specs",
    ...
    config_mgr_type.def("get_documentation_for_spec",
