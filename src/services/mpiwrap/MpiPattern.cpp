...
void MpiPattern::handle_send_init(Caliper*     c,
                                  Channel*     chn,
                                  int          count,
                                  MPI_Datatype type,
                                  int          dest,
...
void MpiPattern::handle_recv(Caliper* c,
                             Channel* chn,
                             int,
                             MPI_Datatype type,
                             int,
...
void MpiPattern::handle_irecv(Caliper*     c,
                              Channel*     chn,
                              int          count,
                              MPI_Datatype type,
                              int          src,
...
void MpiPattern::handle_recv_init(Caliper*     c,
                                  Channel*     chn,
                                  int          count,
                                  MPI_Datatype type,
                                  int          src,
