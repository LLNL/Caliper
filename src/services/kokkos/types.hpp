...
using allocation_callback   = util::callback<void(const SpaceHandle, const char*, const void* const, const uint64_t)>;
using deallocation_callback = util::callback<void(const SpaceHandle, const char*, const void* const, const uint64_t)>;

using begin_deep_copy_callback = util::callback<
    void(const SpaceHandle, const char*, const void*, const SpaceHandle, const char*, const void*, const uint64_t)>;
