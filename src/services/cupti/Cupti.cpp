...
class CuptiService
{
    ...
    static void CUPTIAPI cupti_callback(void*                userdata,
        ...
        case CUPTI_CB_DOMAIN_RUNTIME_API:
            instance->handle_callback(cbid,
                                      static_cast<CUpti_CallbackData*>(cbInfo),
    ...
    void snapshot_cb(Caliper* c, SnapshotBuilder& snapshot) {
...
public:
    ...
    static void cuptiservice_initialize(Caliper* c, Channel* chn) {
        ...
        chn->events().post_init_evt.connect(
            [instance](Caliper* c, Channel* channel) { instance->subscribe_attributes(c, channel); });
