...
class CuptiTraceService
{
    ...
    CuptiTraceService(Caliper* c, Channel* chn) : channel { *chn }
    {
        ...
        activity_duration_attr = c->create_attribute(
        ...
        uvm_pagefault_groups_attr = c->create_attribute(
            "cupti.uvm.pagefault.groups",
            CALI_TYPE_UINT,
            CALI_ATTR_ASVALUE | CALI_ATTR_SKIP_EVENTS | CALI_ATTR_AGGREGATABLE
        );
        uvm_migration_cause_attr = c->create_attribute(
