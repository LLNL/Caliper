...
class PapiService {
  ...
  PapiService(Caliper *c, Channel *channel)
      : m_enable_multiplex(false), m_num_eventsets(0), m_num_event_mismatch(0),
        m_num_failed_acquire(0), m_num_failed_read(0), m_num_failed_reset(0),
        m_num_failed_start(0), m_num_threads(0), m_thread_list(nullptr) {
