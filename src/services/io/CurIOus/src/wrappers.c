...
io_function_data_t io_fns[CURIOUS_FUNCTION_COUNT] = {
  ...
  [CURIOUS_WRITE_ID]      = { CURIOUS_POSIX  },
  [CURIOUS_OPEN_ID]       = { CURIOUS_POSIX  },
  [CURIOUS_CLOSE_ID]      = { CURIOUS_POSIX  },
  [CURIOUS_STAT_ID]       = { CURIOUS_POSIX  },
  [CURIOUS__STAT_ID]      = { CURIOUS_POSIX  },
  [CURIOUS_LSTAT_ID]      = { CURIOUS_POSIX  },
  [CURIOUS__LSTAT_ID]     = { CURIOUS_POSIX  },
  [CURIOUS_XSTAT_ID]      = { CURIOUS_POSIX  },
  [CURIOUS__XSTAT_ID]     = { CURIOUS_POSIX  },
  [CURIOUS_XSTAT64_ID]    = { CURIOUS_POSIX  },
  [CURIOUS__XSTAT64_ID]   = { CURIOUS_POSIX  },
  [CURIOUS_LXSTAT_ID]     = { CURIOUS_POSIX  },
  [CURIOUS__LXSTAT_ID]    = { CURIOUS_POSIX  },
  [CURIOUS_LXSTAT64_ID]   = { CURIOUS_POSIX  },
  [CURIOUS__LXSTAT64_ID]  = { CURIOUS_POSIX  },
  [CURIOUS_FSTAT_ID]      = { CURIOUS_POSIX  },
  [CURIOUS__FSTAT_ID]     = { CURIOUS_POSIX  },
  [CURIOUS_FXSTAT_ID]     = { CURIOUS_POSIX  },
  [CURIOUS__FXSTAT_ID]    = { CURIOUS_POSIX  },
  [CURIOUS_FXSTAT64_ID]   = { CURIOUS_POSIX  },
  [CURIOUS__FXSTAT64_ID]  = { CURIOUS_POSIX  },
  [CURIOUS_FOPEN_ID]      = { CURIOUS_CSTDIO },
  [CURIOUS_FOPEN64_ID]    = { CURIOUS_CSTDIO },
  [CURIOUS_FDOPEN_ID]     = { CURIOUS_CSTDIO },
  [CURIOUS_FREOPEN_ID]    = { CURIOUS_CSTDIO },
  [CURIOUS_FCLOSE_ID]     = { CURIOUS_CSTDIO },
  [CURIOUS_PRINTF_ID]     = { CURIOUS_CSTDIO },
  [CURIOUS_FPRINTF_ID]    = { CURIOUS_CSTDIO },
  [CURIOUS_VPRINTF_ID]    = { CURIOUS_CSTDIO },
  [CURIOUS_VFPRINTF_ID]   = { CURIOUS_CSTDIO },
  /*
  ...
  */
  [CURIOUS_FGETC_ID]      = { CURIOUS_CSTDIO },
  [CURIOUS_FGETS_ID]      = { CURIOUS_CSTDIO },
  [CURIOUS_GETCHAR_ID]    = { CURIOUS_CSTDIO },
//[CURIOUS_GETS_ID]       = { CURIOUS_CSTDIO },
  [CURIOUS_FREAD_ID]      = { CURIOUS_CSTDIO },
  [CURIOUS_FWRITE_ID]     = { CURIOUS_CSTDIO },
};
