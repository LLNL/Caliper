...
const char* builtin_option_specs =
    ...
    " \"query args\"  : "
    " ["
    "   { \"level\": \"local\", \"select\": [ { \"expr\": \"sum(sum#io.bytes.written)\", \"as\": \"Bytes written\" } ] },"
    "   { \"level\": \"cross\", \"select\":"
    ...
    " \"query args\"  : "
    " ["
    "   { \"level\": \"local\", \"select\": [ { \"expr\": \"sum(sum#io.bytes.read)\", \"as\": \"Bytes read\" } ] },"
    "   { \"level\": \"cross\", \"select\":"
    ...
    " \"query args\"  : "
    " ["
    "   { \"level\": \"local\", \"select\": [ { \"expr\": \"max(max#alloc.region.highwatermark)\", \"as\": \"Max Alloc'd Mem\" } ] },"
