...
const char* builtin_option_specs =
    ...
    "         { \"expr\": \"inclusive_max(umpt.count)\", \"as\": \"Num allocs (Total)\" }"
    "       ]"
    "   },"
    "   { \"level\"   : \"cross\", "
    "     \"select\"  : "
    "       [ { \"expr\": \"max(imax#umpt.size)\", \"as\": \"Allocated MB/rank (Max)\", \"unit\": \"MB\" }, "
    "         { \"expr\": \"max(imax#umpt.count)\", \"as\": \"Num allocs/rank (Max)\" }"
    "       ]"
    "   }"
    " ]"
    "},"
    ...
    "         { \"expr\": \"inclusive_max(ump.size)\", \"as\": \"Allocated MB\", \"unit\": \"MB\" },"
    "         { \"expr\": \"inclusive_max(ump.hwm)\", \"as\": \"Highwatermark\" }"
    "       ],"
    ...
    "     \"select\"  : "
    "       [ { \"expr\": \"umpire.alloc.name\", \"as\": \"Allocator\" },"
    "         { \"expr\": \"max(imax#ump.size)\", \"as\": \"Allocated MB/rank (Max)\", \"unit\": \"MB\" }, "
    "         { \"expr\": \"max(imax#ump.hwm)\", \"as\": \"Highwatermark (Max)\" }"
    "       ],"
    "     \"group by\": [ \"umpire.alloc.name\" ]"
    "   }"
    " ]"
