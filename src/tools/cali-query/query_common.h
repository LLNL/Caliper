...
public:
    ...
    QueryArgsParser() : m_error(true), m_error_msg("query not read") {}
...
struct SnapshotFilterStep {
    ...
    void operator() (CaliperMetadataAccessInterface& db, const EntryList& list) { m_filter_fn(db, list, m_push_fn); }
};
