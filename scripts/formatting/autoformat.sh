...
SUPPORTED_CLANG_FORMAT_VERSION="16.0.6"
...
echo "Formatting C/C++ code in 'examples'"
find examples -name "*.c" -or -name "*.cpp" -or -name "*.h" -or -name "*.hpp" | xargs $clang_format_exe -i

echo "Formatting C/C++ code in 'test'"
find test -name "*.c" -or -name "*.cpp" -or -name "*.h" -or -name "*.hpp" | xargs $clang_format_exe -i
